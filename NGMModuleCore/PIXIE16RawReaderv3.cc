...
////// PIXIE16RawReaderv3 Implementation
ClassImp(PIXIE16RawReaderv3)

PIXIE16RawReaderv3::PIXIE16RawReaderv3()
{
  _rawhdrbuffer = 0;
  _rawbuffer = 0;
  _nrawbuffers = 0;
...
PIXIE16RawReaderv3::PIXIE16RawReaderv3(NGMModule* parent)
...
void PIXIE16RawReaderv3::SetConfiguration(const NGMSystemConfiguration* sysConf)
{
...
//
//NGMSystemConfiguration* PIXIE16RawReaderv3::CreateConfigurationFromPIXIE()
//{
//  
//}


Long64_t PIXIE16RawReaderv3::OpenInputFile(const char* filename)
{
...
void PIXIE16RawReaderv3::deleteRawBuffers(){
...
void PIXIE16RawReaderv3::createRawBuffers(int nmodules)
{
...
Long64_t PIXIE16RawReaderv3::OpenRawBinaryFile(const char* pathname)
{
  FileStat_t pathinfo;
...
Long64_t PIXIE16RawReaderv3::ReadAll()
{
...
Long64_t PIXIE16RawReaderv3::CloseInputFile()
{
  if(_inputfile)
  {
    if(_inputfile->is_open())
...
Long64_t PIXIE16RawReaderv3::ReadNextBufferFromFile()
{
  return ReadNextBufferFromFilev2();
}

Long64_t PIXIE16RawReaderv3::ReadNextBufferFromFilev2()
{
  ...
  if(bytesRead>0)
  {
    Long64_t status = writePacket(packetLengthInWords+_rawbufferstart[moduleid], _rawbuffer[moduleid], _outBuffer, moduleid);
    if(status) return 0;
...
int PIXIE16RawReaderv3::AnaStats(NGMBufferedPacket* packet)
{
...
Long64_t PIXIE16RawReaderv3::readBytesWaiting(Long64_t nbytesToRead, unsigned int* rawbuffer, bool waitOnData, size_t localOffsetInBytes)
{
...
Long64_t PIXIE16RawReaderv3::writePacket(int packetlength, unsigned int *data, NGMBufferedPacket* &_outBuffer, int moduleid)
{
  // Parsing Info
