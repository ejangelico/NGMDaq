#ifndef __NCAArray2d_H__
#define __NCAArray2d_H__
...
public:
    ...
    void CopyValues(Array2d *arrayToCopy);
    void AddArrays(Array2d *array1, Array2d *array2, Double_t scale1=1.0, Double_t scale2=1.0);
    void DivideArrays(Array2d *array1, Array2d *array2);
    void MultiplyArrays(Array2d *array1, Array2d *array2, Double_t scale1=1.0, Double_t scale2=1.0);
    ...
    Bool_t RehistogramArrayByArea(Array2d *arrayOld, Bool_t bCyclic=false, Double_t acceptanceRadius=-1.0);
    Bool_t RehistogramArrayByInterpolation(Array2d *arrayOld, Double_t acceptanceRadius=-1.0);
    Int_t GetRebinnedContribution(Int_t theXbin, Int_t theYbin, Array2d *arrayOld,
                                  Int_t *binNumsX, Int_t *binNumsY, Double_t *binWeights,
                                  Bool_t bCyclic=false, Double_t acceptanceRadius=-1.0);
    Double_t GetFractionalCoverage(Int_t iThisX, Int_t iThisY, Array2d *arrayOld, Int_t iOldX, Int_t iOldY);
    
    TH2F * GetArrayHistogram(const Char_t *histName, Bool_t bAbs=true);
    Array2d * GetContentArray(Int_t bins, Double_t xLo, Double_t xHi);
    Array2d * GetContentArray(Int_t bins, Double_t axisPaddingFraction=0.1);
    static Array2d * GetArray(TH2 *histogram);
    virtual Array2d * Clone(Bool_t bZeroValues=false);
