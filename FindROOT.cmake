...
IF (ROOT_CONFIG_EXECUTABLE)
  ...
  #use this block for root version above 6.28
  ...
  #this one for root 6.22, for example
...
MACRO (ROOT_GENERATE_DICTIONARY INFILES LINKDEF_FILE OUTFILE INCLUDE_DIRS_IN LIBNAME)
...
ARGS -f ${OUTFILE} -c -DHAVE_CONFIG_H -rmf lib${LIBNAME}.rootmap -rml lib${LIBNAME}.so -s lib${LIBNAME} ${INCLUDE_DIRS} ${INFILES} ${LINKDEF_FILE} DEPENDS ${INFILES} ${LINKDEF_FILE})
