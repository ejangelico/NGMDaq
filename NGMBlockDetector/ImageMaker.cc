...
//    if(hDHP) hDHP->Reset();
    ...
    if(iMask<=0){
        if(hDHPm) delete hDHPm;
        if(hDHP) delete hDHP;
        if(hDecoder) delete hDecoder;
        if(hDecS) delete hDecS;
    ...
    if(hDecoderStandard) delete hDecoderStandard;// hDecoderStandard->Reset();
    ...
    if(hDHPm){
        ...
        delete hRebinnedDetM;
        delete hRebinnedDetAddM;
        delete hDetAbsAxisM;
    }
    ...
    if(hDHPa){
        ...
        delete hDetAbsAxisA;
        delete hRebinnedDetA;
        delete hRebinnedDetAddA;
    }
...
TH2D *ImageMaker::GetImage3(TH2D *hMaskDetectorHitPattern, TH2D *hAntiDetectorHitPattern, Bool_t bOffset, Bool_t bAdd, Bool_t bDoubleSample){
    ...
    if(!bDoubleSample){
        ...
        delete hRebinnedDetAddSS_0;
        delete hRebinnedDetSS_0;
    }
    ...
    delete hDataMove;
    delete hUseData;
    delete hDecoderToUse;
    delete hDecoderSS;
    delete hRebinnedDetAddSS;
    delete hRebinnedDetSS;
